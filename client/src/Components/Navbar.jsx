...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <nav className='w-full px-4 bg-white flex shadow border-gray-400 text-gray-500 justify-between items-center h-[10vh]'>
            ...
            {/* Drop down menus start here */}
              <div className='flex'>
                ...
                <div className='mx-2 block' onMouseOut={()=>{setTimeout(()=>{setTeamClicked(false)},3000)}}>
                  ...
                  <div className={teamClicked?"flex absolute justify-start text-[0.85rem]  bg-white shadow-lg rounded mt-2 flex-col space-y-2":"hidden"}>
                    <button className=" hover:bg-[#2a67b11e] p-2 px-4 rounded"><Link to="/CookOff" >2023-24 Team</Link></button>
                  </div>
                </div>
              </div>
