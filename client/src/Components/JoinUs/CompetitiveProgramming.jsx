  ...
  return (
    <>
      ...
      <div className="mb-3 w-full md:w-1/2 px-2">
        ...
        <input
          className={`form-control ${errors.cpProfile ? 'border-red-500' : ''}`}
          name="cpProfile"
          type="text"
          id="cpProfile"
      ...
      <div className="mb-3 w-full px-2">
        ...
        <textarea
          className={`form-control ${
            errors.cpExperience ? 'border-red-500' : ''
          }`}
          name="CP Experience"
          type="text"
          id="cpExperience"
      ...
      <div className="mb-3 w-full px-2">
        ...
        >
          Will you be up for solving coding contests every week and participate
          in post contest discussions?{' '}
          <FaAsterisk className="text-red-500 ml-[2px] text-[6px]" />
        </label>
        <select
