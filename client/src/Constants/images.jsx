/* *************************************************
Got to "https://blurha.sh/" inorder to generate "hashCode" for any image you want
*************************************************** */
...
import cookOffImg4 from "../assets/Events/CookOff2024/img4.JPG";
import cookOffImg5 from "../assets/Events/CookOff2024/img5.JPG";
import cookOffImg6 from "../assets/Events/CookOff2024/img6.JPG";
import cookOffImg7 from "../assets/Events/CookOff2024/img7.JPG";
// **************************************************

// faculty coordinator image import ********************
...
export const HomeGalleryImages = [
  { url: image1, hashCode: "L2CsBZ%~0$D400t7-nxu008wz;yY" },
  { url: image2, hashCode: "LkGlL=oeaztS.9s:ofbc_Noff6og" },
  { url: image3, hashCode: "LYH2WX8^xsoz?wMvbIt8EOjXs.tR" },
  { url: image4, hashCode: "LmFic8M{?b%M~qR%%M%M%LWVs:of" },
  { url: image5, hashCode: "LZI5PhIU-;RP?bbIozs:~qofR*oz" },
  { url: image6, hashCode: "LYF$V2Myt3V[_NIVafofx]RjaetR" },
];

// exporting CookOff-2024 Gallery Images
export const CookOff2024GalleryImages = [
  { url: cookOffImg1, hashCode: "LeMa9QDi_No#?HV?RjRkkpX7Rjn~" },
  { url: cookOffImg6, hashCode: "L37^GT2UMzrW{xBANGxbvxJTniNG" },
  { url: cookOffImg3, hashCode: "LYH2WX8^xsoz?wMvbIt8EOjXs.tR" },
  { url: cookOffImg4, hashCode: "L46t]-xa~qR*00oL9FofIoozIU$%" },
  { url: cookOffImg5, hashCode: "LAA^2k%1?^%N8_jYIUM{nN-;M{s:" },
  { url: cookOffImg2, hashCode: "LXIhNrVY$~Vs~XMeVsn$.7M{V@xt" },
  { url: cookOffImg7, hashCode: "LAE.w^_NA0Dh4TNL~T%f%MnNIrNF" },
];
