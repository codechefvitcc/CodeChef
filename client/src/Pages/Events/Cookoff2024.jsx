...
const CookOff2024 = () => {
  ...
  return (
    <div className="App">
      <div className="overflow-hidden container mx-auto p-4 lg:p-32 lg:pt-4">
        {/* Main Image */}
        ...
        {/* Heading */}
        <h1 className="text-5xl lg:text-7xl font-bold mb-2 text-gray-700">T Shirt Distribution</h1>
        {/* Date */}
        <p className="text-gray-600 mb-4">Jan 10, 2024</p>
        {/* Sub heading */}
        <h2 className="text-2xl lg:text-3xl font-semibold mb-2 text-gray-700">
        ...
        {/* Carousel Ends */}
        <h2 className="text-2xl lg:text-3xl font-semibold mb-2 mt-8 text-gray-700">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sodales magna sapien, sed aliquet augue condimentum eu. Phasellus velit dolor, viverra et ante luctus, pharetra accumsan orci.
        </h2>
        <p className="text-black mb-8">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Non blandit massa enim nec. Scelerisque viverra mauris in aliquam sem at. Risus viverra adipiscing at in tellus. Sociis natoque penatibus et magnis dis parturient montes. Ridiculus mus mauris vitae ultricies leo. Neque egestas congue quisque egestas diam. Risus in hendrerit gravida rutrum quisque non.
