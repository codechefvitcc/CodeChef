...
const mockDataLatestBlog = {
  ...
  about: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas, laudantium recusandae blanditiis earum, distinctio quisquam ullam voluptates, autem iste adipisci dicta! Lorem ipsum dolor sit amet consectetur adipisicing elit.",
  details: "Amet minus quo, omnis quam quos aut? Iste incidunt veritatis adipisci non iusto. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas, laudantium recusandae blanditiis earum, distinctio quisquam ullam voluptates, autem iste adipisci dicta! Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet minus quo, omnis quam quos aut? Iste incidunt veritatis adipisci non iusto.",
}
...
const LatestBlogCard = ({title, image, date, about, details}) => {
  ...
  const shortDetail = details.length > 300 ? `${details.substring(0, 300)}...` : details;
  const shortTitle = title.length > 25 ? `${title.substring(0, 25)}...` : title;

  return (
    <div 
      className='bg-white border-[2px] border-gray-300 p-[10px] rounded-[16px] grid grid-cols-2 gap-[30px] max-w-[800px]'
    >
      <div className='flex flex-col justify-between'>
        ...
        <div className='flex flex-col gap-[10px]'>
          <p className='mt-4 mb-1.5 text-[#8a4af3] text-[15px] font-semibold'>{date}</p>

          <div className='flex justify-between items-center'>
            <h3 className='mb-1.5 font-semibold text-[24px] capitalize'>{shortTitle}</h3>
      ...
      <div className='flex flex-col justify-between text-gray-600'>
        ...
        {details.length > 300 && <div className='font-semibold text-gray-500 text-[18px]'>Read more...</div>}
      </div>
    </div>
  )
}
